...
type TicketAdmissionResult = { seat_id: number; seat_code: string; floor_name: string; assignee_name: string | null; group_name: string | null; entrance_name: string; admitted_at: string };
